<div>
    ...
    <form class="w-full"  >
        ...
        <div class="mb-5" wire:ignore>
            <x-input-label for="short_description" :value="__('short_Description')" />
            <textarea class="w-full p-2 mt-1 border rounded bg-gray-50" id="short_description" name="short_description" wire:model='short_description'>{{ $short_description }}</textarea>
        </div>
