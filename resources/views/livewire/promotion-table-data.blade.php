                ...
                @forelse ($items as $item)
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <th scope="row"
                            ...
                            <a href="{{ asset('assets/images/promotions/' . $item->image) }}" class="glightbox">
                                <img src="{{ asset('assets/images/promotions/thumb/' . $item->image) }}"
                        ...
                        <x-table-data class="line-clamp-1" value="{{ $item->link }}" />
